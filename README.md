...
```bash
curl -sSL https://raw.githubusercontent.com/YOUR_USERNAME/arty.sh/main/arty.sh | sudo tee /usr/local/bin/arty > /dev/null
...
```bash
git clone https://github.com/YOUR_USERNAME/arty.sh.git
cd arty.sh
